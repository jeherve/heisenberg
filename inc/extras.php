 ...
 * @since Heisenberg 1.0
 */
function heisenberg_page_menu_args( $args ) {
	$args['show_home'] = true;
	return $args;
}
add_filter( 'wp_page_menu_args', 'heisenberg_page_menu_args' );
 ...
 * @since Heisenberg 1.0
 */
function heisenberg_enhanced_image_navigation( $url, $id ) {
...
add_filter( 'attachment_link', 'heisenberg_enhanced_image_navigation', 10, 2 );
